...
COUNTERFLOW_TAGLINE         = "Retail Management & Billing System"
COUNTERFLOW_WINDOW_TITLE    = "CounterFlow — Retail Management & Billing"
...
COUNTERFLOW_LOW_STOCK_THRESHOLD     = 5          # Alert when stock falls at or below this
COUNTERFLOW_MAX_BILL_ITEMS          = 100        # Max unique products in one bill
COUNTERFLOW_CURRENCY_SYMBOL         = "₹"
COUNTERFLOW_CURRENCY_LOCALE         = "en_IN"
...
def counterflow_get_db_url() -> str:
    """Return the CounterFlow SQLite database URL."""
    return COUNTERFLOW_DB_URL
